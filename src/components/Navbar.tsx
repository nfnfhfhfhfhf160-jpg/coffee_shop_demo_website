    ...
    >
      <div className={cn(
        ...
        <div className="flex items-center gap-3 group cursor-pointer">
          <div className="p-3 bg-gradient-to-br from-primary to-secondary rounded-2xl group-hover:rotate-[15deg] transition-transform duration-500 shadow-lg shadow-primary/30">
            <Coffee className="w-6 h-6 text-black" />
          </div>
          <span className="font-headline font-bold text-2xl tracking-tighter">
            Aura <span className="text-gradient">Brews</span>
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-10 text-[10px] font-black uppercase tracking-[0.3em]">
          ...
          <a href="#gallery" className="hover:text-primary transition-colors relative group">
            Vibe
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full" />
          </a>
          <a href="#reservations" className="hover:text-primary transition-colors relative group">
            Book
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full" />
          </a>
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3 px-5 py-2.5 glass-card rounded-full border-white/10 group cursor-default">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest hidden sm:inline">We are Open</span>
          </div>
          
          <div className="hidden lg:flex items-center gap-3 text-muted-foreground hover:text-white transition-colors cursor-pointer">
